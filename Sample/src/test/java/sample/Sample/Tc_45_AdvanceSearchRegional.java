...
public class Tc_45_AdvanceSearchRegional extends BaseClass {
	
	@Test(groups = "smokeTest")
	public  void AdvanceSearch() throws Throwable
	{

	String opportunity = eLib.getExcelData("Opportunity", 5, 2);
	String Relatedto =eLib.getExcelData("Opportunity", 5, 3);
	String Assigned = eLib.getExcelData("Opportunity", 5, 4);
	String Sales = eLib.getExcelData("Opportunity", 5, 5);
	String Search = eLib.getExcelData("Opportunity", 5, 6);
	String In = eLib.getExcelData("Opportunity", 5, 7);
	String dd =eLib.getExcelData("Opportunity", 5, 8);
	String Adv = eLib.getExcelData("Opportunity", 5, 9);
	...
	public void AdvanceSearchRegional() throws Throwable {
		/* create object to utiltiy*/
		
	
		/*read test script data*/
		
		String opportunity = eLib.getExcelData("Opportunity", 1, 2);
		String Relatedto =eLib.getExcelData("Opportunity", 1, 3);
		String Assigned = eLib.getExcelData("Opportunity", 1, 4);
		String Sales = eLib.getExcelData("Opportunity", 1, 5);
		String Search = eLib.getExcelData("Opportunity", 1, 6);
		String In = eLib.getExcelData("Opportunity", 1, 7);
		String dd =eLib.getExcelData("Opportunity", 1, 8);
		String Adv = eLib.getExcelData("Opportunity", 1, 9);
