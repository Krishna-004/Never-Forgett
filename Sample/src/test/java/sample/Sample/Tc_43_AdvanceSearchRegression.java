...
public class Tc_43_AdvanceSearchRegression extends BaseClass {
	
	@Test(groups = "regressionTest")

	public  void AdavanceSearch() throws Throwable {
	
		/*read test script data*/
		
		String opportunity = eLib.getExcelData("Opportunity", 3, 2);
		String Relatedto =eLib.getExcelData("Opportunity", 3, 3);
		String Assigned = eLib.getExcelData("Opportunity", 3, 4);
		String Sales = eLib.getExcelData("Opportunity", 3, 5);
		String Search = eLib.getExcelData("Opportunity", 3, 6);
		String In = eLib.getExcelData("Opportunity", 3, 7);
		String dd =eLib.getExcelData("Opportunity", 3, 8);
		String Adv = eLib.getExcelData("Opportunity", 3, 9);
