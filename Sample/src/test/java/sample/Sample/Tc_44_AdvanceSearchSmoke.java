...
public class Tc_44_AdvanceSearchSmoke extends BaseClass {
	...
	public void AdvanceSearch() throws Throwable {
		...
		String opportunity = eLib.getExcelData("Opportunity", 4, 2);
		String Relatedto =eLib.getExcelData("Opportunity", 4, 3);
		String Assigned = eLib.getExcelData("Opportunity", 4, 4);
		String Sales = eLib.getExcelData("Opportunity", 4, 5);
		String Search = eLib.getExcelData("Opportunity", 4, 6);
		String In = eLib.getExcelData("Opportunity", 4, 7);
		String dd =eLib.getExcelData("Opportunity", 4, 8);
		String Adv = eLib.getExcelData("Opportunity", 4, 9);
